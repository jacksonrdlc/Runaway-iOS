...
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Users can read own commitments" ON daily_commitments;
DROP POLICY IF EXISTS "Users can insert own commitments" ON daily_commitments;
DROP POLICY IF EXISTS "Users can update own commitments" ON daily_commitments;
DROP POLICY IF EXISTS "Users can delete own commitments" ON daily_commitments;
...
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Users can read own goals" ON running_goals;
DROP POLICY IF EXISTS "Users can insert own goals" ON running_goals;
DROP POLICY IF EXISTS "Users can update own goals" ON running_goals;
DROP POLICY IF EXISTS "Users can delete own goals" ON running_goals;
...
-- NOTE: quick_wins table does not exist, RLS skipped
...
-- FROM pg_policies
-- WHERE tablename IN ('athletes', 'activities', 'daily_commitments', 'running_goals')
...
-- AND tablename IN ('athletes', 'activities', 'daily_commitments', 'running_goals');
