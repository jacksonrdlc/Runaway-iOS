-- =====================================================
-- Migration: Add Performance Indexes (FIXED VERSION)
...
-- NOTE: quick_wins table does not exist, index skipped
-- NOTE: Activity type index removed - column name may vary
-- If you want to add it, first check your schema with 000_check_schema.sql
