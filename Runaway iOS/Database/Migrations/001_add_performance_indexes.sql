...
-- Index for activity types filtering (for statistics and analytics)
...
-- NOTE: quick_wins table index removed - table may not exist in your schema
-- If you have a quick_wins table, you can add this index manually:
-- CREATE INDEX IF NOT EXISTS idx_quick_wins_athlete_date ON quick_wins(athlete_id, created_at DESC);

-- =====================================================
-- Verification Queries
-- =====================================================
-- Run these to verify indexes were created:
-- SELECT indexname, indexdef FROM pg_indexes WHERE tablename IN ('activities', 'daily_commitments', 'running_goals') ORDER BY tablename, indexname;
